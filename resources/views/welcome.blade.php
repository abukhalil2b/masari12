        ...
        <div class="container mx-auto font-frutiger">
            <nav
                ...
                <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto my-5 sm:my-0">
                    <div
                        class="px-8 sm:px-0 flex-wrap justify-between sm:justify-center flex text-xl flex-grow lg:pl-16">
                    ...
                    <div class="justify-center flex absolute sm:relative ml-4 mt-4 sm:mt-0 sm:ml-0 left-0 top-0">
                        <a href="/login"
                            class="block border text-black border-white w-full text-center sm:inline-block py-4 text-lg px-10 leading-none rounded bg-white mt-4 lg:mt-0">
                            دخول المنصة
                        </a>
                    </div>
                </div>
            ...
            <div class="text-center HomeHero pb-10 sm:pb-40">
                <h1 class="text-white text-4xl sm:text-6xl font-bold md:pt-48 text-center">مساري حيث لا حدود للتطوير
                </h1>
                <a
                    class="mt-10 mx-10 text-white font-frutiger bg-caribeanGreen block sm:inline-block border pt-3 pb-4 px-16 text-xl rounded border-caribeanGreen hover:bg-green-800 cursor-pointer">
                    سجل في المنصة
                </a>
            </div>
        </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto">
                ...
                <div class="w-full sm:w-1/3 px-4 mb-8">
                    <div
                        ...
                        <div class="p-6">
                            ...
                            <a href="#" class="text-caribeanGreen font-semibold hover:underline">التفاصيل
                                &rarr;</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center mt-8">
                <a href="#"
                    class="inline-block bg-caribeanGreen text-white px-8 py-3 rounded-lg hover:bg-opacity-90 transition-colors duration-300">
                    عرض جميع الدورات
                </a>
            </div>
        </div>
            ...
            <div class="flex flex-wrap px-4 sm:px-0 -mx-4">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
                    <div
                        ...
                        <img src="/images/news.png" alt="منصة مساري وتحقيق أولوية رؤية عُمان 2040"
                            class="w-full h-48 object-cover">
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-tiber mb-2 truncate">منصة مساري وتحقيق أولوية رؤية عُمان
                                2040</h3>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
                    <div
                        class="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
                        <img src="/images/puplish.jpg" alt="تدشين برنامج مساري للتنمية البشرية"
                            class="w-full h-48 object-cover">
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-tiber mb-2 truncate">تدشين برنامج مساري للتنمية البشرية
                            </h3>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
                    <div
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-tiber mb-2 truncate">ورشة عمل حول التخطيط الاستراتيجي
                            </h3>
        ...
        <div class="container mx-auto py-12">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex flex-wrap justify-center md:justify-end gap-6">
                    <a href="#"
                        class="text-nevada hover:text-caribeanGreen transition-colors duration-300">سياسة الخصوصية</a>
                    <a href="#"
                        class="text-nevada hover:text-caribeanGreen transition-colors duration-300">الشروط والأحكام</a>
                    <a href="#"
                        class="text-nevada hover:text-caribeanGreen transition-colors duration-300">الدورات</a>
                    <a href="#" class="text-nevada hover:text-caribeanGreen transition-colors duration-300">كن
                        مدرب معنا</a>
                    <a href="#" class="text-nevada hover:text-caribeanGreen transition-colors duration-300">اتصل
                        بنا</a>
                </div>
            </div>

            <div class="border-t border-gray-200 mt-8 pt-8 text-center">
                <p class="text-nevada">جميع الحقوق محفوظة لوزارة الأوقاف والشؤون الدينية &copy; <span
                        id="year"></span></p>
            </div>
        </div>
    </footer>
